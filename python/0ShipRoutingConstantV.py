...
## inputs for project
#time=input('given time(s):')
#sx=input('start point(x):')
#sy=input('start point(y):')
#gx=input('goal point(x):')
#gy=input('goal point(y):')
## for grids
## xrow,ycol
...
sx, sy = 3, 3
gx, gy = 13, 13
Vs=(abs(sx-gx)+abs(sy-gy))/t           #Velocity of ship
xrow=15
ycol=15
...
rx, ry, TotalCost = dijkstra.planning(sx, sy, gx, gy,CF_N,CF_E,CF_S,CF_W)
print(TotalCost)
